...
object TweetsPreProcessing{
  ...
  var negationWords = List("not","rather","hardly","couldnt","wasnt","didnt","wouldnt","shouldnt","werent","dont","doesnt","havent","hasnt","wont","wont","hadnt")
